...
// Other
// Other
global.botname = "AyameBotz" //namabot kalian
global.ownername = "Fajar" //nama kalian
global.myweb = "https://desty.page/frenzyedtz" //bebas asal jan hapus
global.youtube = "https://youtube.com/@FuadXyro" //bebas asal jan hapus
global.email = "MuhammadHairilxxx@gmail.com(biar kaga di maling:p)" //bebas
global.region = "Indonesia" //bebas
global.timezone = 'Asia/Jakarta' //  timezone wib
global.premium = ['6281258728320'] //premium user
global.owner = ["6281258728320"] //ganti agar fitur owner bisa di gunakan
global.ownernomer = "6281258728320" // nomor wa kalian
global.ownernomerr = "+62 812-5872-8320" //nmr wa kalian
...
global.author = 'AyameBotz' //sticker wm ganti nama kalian
...
role(level) {
    ...
    const role = [
      ...
      { name: 'Master V', level: 40 }, { name: 'Master IV', level: 44 }, { name: 'Master III', level: 48 }, { name: 'Master II', level: 52 }, { name: 'Master I', level: 56 },
      { name: 'GrandMaster V', level: 60 }, { name: 'GrandMaster IV', level: 64 }, { name: 'GrandMaster III', level: 68 }, { name: 'GrandMaster II', level: 72 }, { name: 'GrandMaster I', level: 76 },
      { name: 'Epic V', level: 80 }, { name: 'Epic IV', level: 84 }, { name: 'Epic III', level: 88 }, { name: 'Epic II', level: 92 }, { name: 'Epic I', level: 96 },
      { name: 'Legend V', level: 100 }, { name: 'Legend IV', level: 104 }, { name: 'Legend III', level: 108 }, { name: 'Legend II', level: 112 }, { name: 'Legend I', level: 116 },
      { name: 'Mythic Mawi V', level: 120 }, { name: 'Mythic Mawi IV', level: 124 }, { name: 'Mythic Mawi III', level: 128 }, { name: 'Mythic Mawi II', level: 132 }, { name: 'Mythic Mawi I', level: 136 },
      { name: 'Mythic Mawi 1-300', level: 140 }, { name: 'Mythic Mawi 1-300', level: 144 }, { name: 'Mythic Mawi 1-300', level: 148 }, { name: 'Mythic Mawi 1-300', level: 152 }, { name: 'Mythic Mawi 1-300', level: 156 },
